...
| `focusTrapProps` | `{ trapFocus?: boolean; autoFocus?: boolean }` | `{ trapFocus: true, autoFocus: false }` | Configuration for focus trap behavior |
...
This component has no props. It renders a visual separator between sections.