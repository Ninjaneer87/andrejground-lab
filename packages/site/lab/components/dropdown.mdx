...
| `showCaret` | `boolean` | `false` | Shows or hides the caret indicator |
...
| `placement` | <PopoverPlacementTypePopover /> | `"bottom-center"` | Preferred placement of the dropdown relative to the trigger |
...
| `shouldCloseOnScroll` | `boolean` | `false` | Closes the dropdown when the page is scrolled |
...
| `openOnHover` | `boolean` | `false` | Opens the dropdown on hover instead of click |
