...
function HomeResizableDemoContent() {
  const [currentWidthLeft, setCurrentWidthLeft] = React.useState<number>(null);
  ...
  return (
    <div className={styles.container}>
      <Resizable
        className={clsx(styles.homeResizable, styles['homeResizable--right'])}
        minWidth={220}
        initialWidth={220}
        maxWidth={280}
        resizableSide="right"
      ...
      <Resizable
        className={clsx(styles.homeResizable, styles['homeResizable--left'])}
        minWidth={220}
        initialWidth={220}
        maxWidth={280}
        resizableSide="left"
