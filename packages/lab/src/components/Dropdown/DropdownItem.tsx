...
const DropdownItem = forwardRef<HTMLElement, DropdownItemProps<ElementType>>(
  (props, ref) => {
    ...
    if (!dropdownContext) {
      throw new Error(
        'DropdownItem should be used within a Dropdown component',
      );
    }
    ...
    const baseClassName = cn(
      styles.item,
      'p-2 focus-visible:bg-gray-200 rounded-lg transition-all w-full flex cursor-pointer items-center gap-2',
